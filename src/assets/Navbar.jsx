                                ...
                                <div className="relative w-8 h-8 flex items-center justify-center">
                                        <FaBars 
                                                className={`absolute transition-all duration-300 ease-in-out transform ${
                                                        nav ? 'rotate-180 scale-0 opacity-0' : 'rotate-0 scale-100 opacity-100 hover:text-gray-300'
                                                }`} 
                                                size={24} 
                                        />
                                        <FaTimes 
                                                className={`absolute transition-all duration-300 ease-in-out transform ${
                                                        nav ? 'rotate-0 scale-100 opacity-100 hover:text-gray-300' : '-rotate-180 scale-0 opacity-0'
                                                }`} 
                                                size={24} 
                                        />
                                </div>
